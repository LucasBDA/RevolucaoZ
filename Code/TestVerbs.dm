...
/*	Old_Parts()
	...
	Add_Clan_Exp()
		...
		var/datum/Clan/G=input("Which Clan would you like to give the amount of Exp?","") as null|anything in Clans
		G.AddClanExp(Amt2Add,src)
		src<<"Added [FullNum(Amt2Add)] Clan Exp for [G]"
	Full_Respec()
		set category="Test"
		src.FullRespec()
	GuardTapping()
...
/*	View_Angles()
	...
	LevelUp()
		set category="Test"
		var/mob/M=input("Who do you want to give Levels?","") as null|anything in Players
		M.AddExp(100*input("Levels to Give:","Give Levels",1) as num)
	DuelSelf()
		set category="Test"
		usr.Duel()
