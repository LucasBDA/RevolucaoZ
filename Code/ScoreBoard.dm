...
mob/verb/ViewScoreBoard()
	set hidden=1
	var
		BgFmt="<body bgcolor=black link=[rgb(94,123,122)] alink=[rgb(94,123,122)] vlink=[rgb(255,255,255)]>"
		TableFmt="<table border=1 bgcolor=[rgb(0,0,64)] width=100%>"
		TdFmt="<b><font color=[rgb(151,210,209)]><center>"
		UL="<u>"
	var/HTML="<title>ScoreBoard</title>[BgFmt]<center>[TableFmt]"
	HTML+="<tr><td colspan=4>[TdFmt]Os [TopCount] melhores jogadores do Revolução Z"
	HTML+="<tr><td>[TdFmt][UL]#<td>[TdFmt][UL]Jogador<td>[TdFmt][UL]Level<td>[TdFmt][UL]Tempo jogando"
	var/counter=0
