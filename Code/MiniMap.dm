...
var/list/ITZ=list(1,7,9)
var/list/MapsWithIT=list("1","7","9","10")
var/list/MapNames=list("1"="Terra","2"="?","3"="?","4"="?","5"="?","6"="?","7"="Namekuzei","8"="?","9"="Sala do Templo","10"="Guerra de Clan")
...
mob/proc/UpdateMiniMapDBs()
	...
	if(src.z==7)	src.client.screen+=global.DBMs-src.DBMsCollected
	else	src.client.screen-=global.DBMs
